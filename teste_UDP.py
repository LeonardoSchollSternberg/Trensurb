...
while cont:
    ...
    if(data == b'apagar'):  #apaga a tabela e cria uma outra
        ...
        mycursor.execute("CREATE TABLE teste (id INT PRIMARY KEY AUTO_INCREMENT, criado_em TIMESTAMP(3) DEFAULT CURRENT_TIMESTAMP(3), message VARCHAR(100));")
        ...
        # mycursor.executemany("SELECT * FROM teste")
        for tb in mycursor:
            print(tb)
sock.close()